...
<html>
    ...
    <body style="background-color: #D4EBE5;">
        ...
        <div class="col-xs-2 col-left">
            <ul>
                <li><a href="createaccount"><button class="btn-success btn">Tạo tài khoản mới</button></a></li>
                <li><a href="listaccount"><button class="btn-success btn">Xem danh sách tài khoản</button></a></li>
                <li><a href="changepass"><button class="btn-success btn">Đổi mật khẩu</button></a></li>
            </ul>
        </div>
